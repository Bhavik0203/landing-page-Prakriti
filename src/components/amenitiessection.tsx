  ...
  return (
    <div className="bg-white min-h-screen overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute top-40 right-20 w-96 h-96 bg-gradient-to-r from-pink-200/30 to-orange-200/30 rounded-full animate-pulse blur-3xl" style={{animationDelay: '1s'}}></div>
        <div className="absolute bottom-20 left-1/3 w-80 h-80 bg-gradient-to-r from-green-200/30 to-cyan-200/30 rounded-full animate-pulse blur-3xl" style={{animationDelay: '2s'}}></div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <div className="flex justify-center space-x-4">
              <div className="flex items-center space-x-2 bg-green-100 px-4 py-2 rounded-full animate-bounce">
                <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                <span className="text-green-700 text-sm font-medium">Ready Infrastructure</span>
              </div>
              <div className="flex items-center space-x-2 bg-blue-100 px-4 py-2 rounded-full animate-bounce" style={{animationDelay: '0.5s'}}>
                <MousePointer className="w-4 h-4 text-blue-600" />
                <span className="text-blue-700 text-sm font-medium">Hover to Explore</span>
              </div>
            </div>
          </div>
            ...
            {amenities.map((amenity, index) => (
              <div key={index} className="group relative">
                ...
                <div className="relative bg-white rounded-3xl p-8 border-2 border-gray-100 group-hover:border-transparent transition-all duration-500 group-hover:shadow-2xl group-hover:-translate-y-4 h-full">
                  ...
                  <h3 className={`text-2xl font-bold mb-4 text-gray-900 group-hover:bg-gradient-to-r group-hover:${amenity.color} group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300`}>
                    {amenity.title}
                  </h3>
          ...
          <div className="text-center mt-16">
            <div className="group relative inline-block">
              {/* Animated background */}
              <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-full blur-lg opacity-70 group-hover:opacity-100 animate-pulse"></div>
              
              <div className="relative bg-gradient-to-r from-gray-900 to-gray-700 text-white px-12 py-6 rounded-full font-semibold text-lg hover:from-blue-600 hover:to-purple-600 transition-all duration-500 cursor-pointer group-hover:scale-110 group-hover:shadow-2xl flex items-center space-x-3">
                <span className="group-hover:animate-pulse">Schedule Site Visit</span>
                <ChevronRight className="w-5 h-5 group-hover:translate-x-2 group-hover:scale-125 transition-transform duration-300" />
              </div>
            </div>
          </div>
        </div>
